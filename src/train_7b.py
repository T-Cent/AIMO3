...
train_7b.py
───────────
Fine-tunes Qwen2.5-Math-7B-Instruct on CGM gold data (both annotation
...
Usage:
    ...
    # Both A100s:
    torchrun --nproc_per_node=2 train_7b.py
